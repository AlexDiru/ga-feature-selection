...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        new FeatureSelector(new DataReader("knimeout.csv"),500,50,0.6,GeneticParameters.DYNAMIC_MUTATION_METHOD_INVERSE_TOTAL_FEATURES,GeneticParameters.__KNN, GeneticParameters.ClassesToUse.ALL).run();
